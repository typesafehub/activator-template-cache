...
sealed class TranslatedException private[asbt](msg: String, cause: Throwable) extends RuntimeException(msg, cause)
{
	override def toString = msg
}
final class TranslatedIOException private[asbt](msg: String, cause: IOException) extends TranslatedException(msg, cause)
